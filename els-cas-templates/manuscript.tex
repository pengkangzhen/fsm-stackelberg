...
(last-comply attribution). Directional on first-probe only; superseded as the
primary Exp-A table by Table~\ref{tab:exp_ablation}.
...
all three methods---motivating verified accounting and evidence-informed rank.
External baselines were not run in that preliminary pass.
