...
against Stackelberg's committed $20/20$. Debate and Reflexion were not
run in this pass (cost freeze until SB verified rates stabilize; reported
as not run, not as wins).

\begin{table}[t]
\centering
\caption{Exp-B internal baselines --- \textbf{measured} (evidence-informed;
snapshot mode; $n{=}20$; $K{=}3$; loop-token accounting). Primary: verified
attribution. External Debate/Reflexion not run.}
