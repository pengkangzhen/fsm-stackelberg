...
and $0/30$ under reverse (paired exact McNemar: $p=1.9\times10^{-9}$ and
$p=6.1\times10^{-5}$): the registered first-probe clause is strongly
supported. Verified attribution is $14/30$ causal, $13/30$ random, $7/30$
...
varies horizon and scenario count at fixed network size, all campaigns
run a single engine under a frozen implementation, and $K$ is capped at
three. Within those bounds the
...
semantic data layer, scaling the network, and a full cross-engine
