...
\paragraph{Illustrative expected pattern (mock; not measured).}
Table~\ref{tab:exp_diag}.

\begin{table}[t]
\centering
\caption{Exp-C diagnostics --- \textbf{illustrative mock} (verified attr.\ vs.\ $K$;
deflect overturn under causal Stackelberg).}
\label{tab:exp_diag}
\label{tab:exp_iv}
\begin{tabular}{@{}l c c c c@{}}
\toprule
Method / $K$ & $K{=}1$ & $K{=}2$ & $K{=}3$ & Deflect overturn \\
\midrule
stackelberg causal & 0.45 & 0.60 & 0.70 & 0.75 \\
adversarial        & 0.50 & 0.55 & 0.60 & --- \\
sequential         & 0.10 & 0.15 & 0.20 & --- \\
\bottomrule
\end{tabular}
\end{table}
