"""ProgrammingExpert — generates Gurobi code for optimization problems."""
...
class ProgrammingExpert(BaseExpert):
    ROLE_DESCRIPTION = (
        ...
        "as Gurobi is essential. In addition to your expertise in Gurobi, it "
        "would be great if you could also provide some background in related "
        "libraries or tools, like NumPy, SciPy, or PuLP."
    )
