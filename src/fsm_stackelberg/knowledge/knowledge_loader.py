...
{content}"""
    ...
    def recommend_modules(
        ...
        # 关键词映射规则
        keyword_mapping = {
            "库存": ["ecr-inventory-dynamics"],
            "平衡": ["ecr-inventory-dynamics"],
            "时序": ["ecr-inventory-dynamics"],
            "延迟": ["ecr-inventory-dynamics"],
            "租箱": ["ecr-leasing"],
            "租赁": ["ecr-leasing"],
            "成本": ["ecr-leasing", "ecr-transport-modes"],
            "节点": ["ecr-node-types"],
            "海港": ["ecr-node-types"],
            "陆港": ["ecr-node-types"],
            "收货人": ["ecr-node-types"],
            "发货人": ["ecr-node-types"],
            "运输": ["ecr-transport-modes"],
            "驳船": ["ecr-transport-modes"],
            "卡车": ["ecr-transport-modes"],
            "铁路": ["ecr-transport-modes"],
            "调运": ["ecr-transport-modes", "ecr-inventory-dynamics"],
            "多商品": ["ecr-mcnf-formulation"],
            "commodity": ["ecr-mcnf-formulation"],
            "foldable": ["ecr-mcnf-formulation"],
            "折叠": ["ecr-mcnf-formulation"],
            "theta": ["ecr-mcnf-formulation"],
            "substitution": ["ecr-mcnf-formulation"],
            "替代": ["ecr-mcnf-formulation"],
        }
